 ...
 */
@WebServlet("/web/system/GetVisaNextWorkDate.json")
public class GetVisaNextWorkDateServlet extends HttpServlet {
  private static final long serialVersionUID = 1L;

  /**
   * @see HttpServlet#HttpServlet()
   */
  public GetVisaNextWorkDateServlet() {
    super();
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    String ReturnDate = service.GetVisaNextWorkDate(avsID, actID, SendDate);
