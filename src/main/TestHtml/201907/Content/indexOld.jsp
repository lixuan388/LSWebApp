...
<!-- 页头 end -->
<div id="LeftBody">
	<div id="tree" style="width: 200px;height: 100%;float: left;overflow: auto;"></div>
</div> 
<div id="MainBody">
	<div id="MainTabDiv" style="height:100%">
		<!-- Nav tabs -->
...
var tree = [
	{
		...
		'nodes': [
			...
			{
				'text': '飞猪订单查询',
				'href': '/Content/TaoBao/Form/alitripTravelTradesSearch.jsp?',
				'id': '22'
			}
		]
	},
