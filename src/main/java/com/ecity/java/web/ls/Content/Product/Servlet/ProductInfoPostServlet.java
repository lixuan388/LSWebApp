...
@WebServlet("/Content/Product/ProductInfoPost.json")

public class ProductInfoPostServlet extends HttpServlet {
...
//    System.out.println(buffer.toString());
    ...
    TablePostData table=new TablePostData("epi_Product_Info","Epi_id",DataRows);
