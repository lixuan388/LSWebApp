...
@WebServlet("/Content/BookingOrder/BookingOrderPost.json")

public class BookingOrderPostServlet extends HttpServlet {
...
//    System.out.println(buffer.toString());
    ...
    TablePostData table=new TablePostData("ebo_BookingOrder","ebo_id",DataRows);
