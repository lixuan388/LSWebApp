...
import com.java.web.weixin.base.WeiXinVariable;
...
public class WeiXinFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    if (OpenID.equals("")) {
      String WebUrl = "http://" + request.getServerName(); // 服务器地址
      ...
      WebUrl = WebUrl + servletRequest.getContextPath() + "/System/Authorize?url=" + Base64EncodedText;

      System.out.println("WeiXinFilter_WebUrl:" + WebUrl);

      WebUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + WeiXinVariable.getAppID()
          + "&redirect_uri=" + URLEncoder.encode(WebUrl, "utf-8")
