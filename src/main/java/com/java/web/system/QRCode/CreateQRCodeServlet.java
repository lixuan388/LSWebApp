package com.java.web.system.QRCode;
...
import com.ecity.java.web.utils.QRCode.MatrixToImageWriter;
...
public class CreateQRCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String url=req.getParameter("url")==null?"http://webapp.hcholiday.com":req.getParameter("url");
