...
layui.define(['laytpl', 'layer'], function(exports){
  ...
  view.loading = function(elem){
    elem.append(
      this.elemLoad = $('<div id="loadingToast" ><div class="weui-mask_transparent"></div><div class="weui-toast"><i class="weui-loading weui-icon_toast"></i><p class="weui-toast__content">数据加载中</p></div></div>')
    );
  };
      ...
      ,success: function(res){
        ...
        //登录状态失效，清除本地 access_token，并强制跳转到登入页
          ...
          view.exit(function(){
            ...
            location.href=setter.ContextPath+"/Login/login.jsp?LastUrl="+encodeURIComponent(options.url);
          });
        }
